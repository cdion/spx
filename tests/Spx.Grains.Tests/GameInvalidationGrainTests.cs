...
public sealed class GameInvalidationGrainTests
{
    ...
    public void NotifyLobbyObservers_LeavesObserversWhenNoneThrow()
    {
        ...
        GameInvalidationGrain.NotifyLobbyObservers(
            gameId,
            observers,
    ...
    public void NotifyLobbyObservers_RemovesObserversThatThrow()
    {
        ...
        var observers = new HashSet<IGameInvalidationObserver>
        {
            workingObserver,
            throwingObserver,
        };
    ...
    public void NotifyMessageObservers_LeavesObserversWhenNoneThrow()
    {
        ...
        GameInvalidationGrain.NotifyMessageObservers(
            gameId,
            observers,
            NullLogger<GameInvalidationGrain>.Instance
        );
    ...
    public void NotifySessionObservers_LeavesObserversWhenNoneThrow()
    {
        ...
        GameInvalidationGrain.NotifySessionObservers(
            gameId,
            observers,
            NullLogger<GameInvalidationGrain>.Instance
        );
