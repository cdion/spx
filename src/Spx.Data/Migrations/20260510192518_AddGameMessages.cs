...
namespace Spx.Data.Migrations
{
    ...
    public partial class AddGameMessages : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SenderKind = table.Column<string>(
                    ...
                    SenderDisplayName = table.Column<string>(
                        type: "character varying(40)",
                        maxLength: 40,
                        nullable: false
                    ),
                    RecipientDisplayName = table.Column<string>(
                        type: "character varying(40)",
                        maxLength: 40,
                        nullable: false
                    ),
                    ...
                    EditedAtUtc = table.Column<DateTime>(
                        type: "timestamp with time zone",
                        nullable: true
                    ),
        ...
        {
            migrationBuilder.DropTable(name: "GameMessages");

            migrationBuilder.DropColumn(name: "VisibleThroughMessageId", table: "GamePlayers");
        }
    }
}
