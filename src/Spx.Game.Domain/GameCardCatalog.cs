...
public static class GameCardCatalog
{
    ...
    public static string GetDisplayName(GameCardDefinition definition) => definition.ToString();

    public static GameCardCategory GetCategory(GameCardDefinition definition) =>
        definition switch
        {
            GameCardDefinition.Extract or GameCardDefinition.Refine or GameCardDefinition.Produce =>
                GameCardCategory.Action,
            GameCardDefinition.Red
            or GameCardDefinition.Yellow
            or GameCardDefinition.Blue
            or GameCardDefinition.Purple
            or GameCardDefinition.Green
            or GameCardDefinition.Orange => GameCardCategory.Resource,
    ...
    public static bool IsMarketCard(GameCardDefinition definition) =>
        definition
            is GameCardDefinition.Extract
                or GameCardDefinition.Refine
                or GameCardDefinition.Produce;
    ...
    public static bool IsBaseResource(GameCardDefinition definition) =>
        definition
            is GameCardDefinition.Red
                or GameCardDefinition.Yellow
                or GameCardDefinition.Blue;

    public static bool IsRefinedResource(GameCardDefinition definition) =>
        definition
            is GameCardDefinition.Purple
                or GameCardDefinition.Green
                or GameCardDefinition.Orange;
    ...
    public static int GetResolutionStep(GameCardDefinition definition) =>
        definition switch
        {
            ...
            or GameCardDefinition.Scout => 0,
            _ => int.MaxValue,
        };

    public static bool TryGetBaseDefinition(
        GameResourceColor color,
        out GameCardDefinition definition
    )
    {
    ...
    public static GameCardDefinition? TryGetRefineOutput(
        GameCardDefinition first,
        GameCardDefinition second
    )
    {
    ...
    )
    {
        recipe = definition switch
        {
            ...
            [
                GameCardDefinition.Red,
                GameCardDefinition.Yellow,
                GameCardDefinition.Blue,
                GameCardDefinition.Purple,
                GameCardDefinition.Green,
                GameCardDefinition.Orange,
            ],
            _ => [],
        };
    ...
    public static bool MatchesRecipe(
        IReadOnlyCollection<GameCardDefinition> consumedCards,
        IReadOnlyCollection<GameCardDefinition> recipe
    ) =>
        consumedCards
            .OrderBy(definition => definition)
            .SequenceEqual(recipe.OrderBy(definition => definition));
}
