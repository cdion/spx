...
public sealed class GameSessionGrainState
{
    ...
    [Id(6)]
    public List<GameSessionGrainCardState> MarketDeck { get; set; } = [];

    [Id(7)]
    public List<GameSessionGrainCardState> VisibleMarketCards { get; set; } = [];

    [Id(8)]
    public List<GameSessionGrainCardState> FirstPlayerHand { get; set; } = [];

    [Id(9)]
    public List<GameSessionGrainCardState> SecondPlayerHand { get; set; } = [];

    [Id(10)]
    public GameSessionPendingBatchGrainState? FirstPlayerPendingBatch { get; set; }

    [Id(11)]
    public GameSessionPendingBatchGrainState? SecondPlayerPendingBatch { get; set; }

    [Id(12)]
    public GameSessionResolvedBatchGrainState? LastResolvedBatch { get; set; }
    ...
    [Id(21)]
    public GameSessionCompletionGrainState? Completion { get; set; }
    ...
    [Id(25)]
    public List<PendingGameplayEventBatchGrainState> PendingGameplayEventBatches { get; set; } = [];
}
...
public sealed class GameSessionPendingBatchGrainState
{
    ...
    [Id(1)]
    public List<GameSessionPendingBatchCardGrainState> Cards { get; set; } = [];
}
...
{
    [Id(0)]
    public GameSessionGrainCardState Card { get; set; } = new();
    ...
    [Id(5)]
    public List<GameSessionCardReferenceGrainState> ConsumedCards { get; set; } = [];
...
public sealed class GameSessionResolvedBatchGrainState
{
    ...
    [Id(1)]
    public List<GameSessionResolvedPlayerBatchGrainState> Players { get; set; } = [];
