...
public sealed class OrleansGameLobbySubscriptionService(
    IClusterClient clusterClient,
    ILogger<OrleansGameLobbySubscriptionService> logger)
    : IGameLobbySubscriptionService, IGameMessageSubscriptionService, IGameLobbyEventsPublisher, IGameMessageEventsPublisher, IGameLobbyObserver
{
    ...
    private sealed class Subscription(OrleansGameLobbySubscriptionService owner, Guid gameId, Guid subscriptionId, SubscriptionKind kind) : IAsyncDisposable
    {
