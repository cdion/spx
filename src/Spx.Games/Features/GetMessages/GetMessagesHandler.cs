...
{
    public async Task<GameTimelinePageView?> HandleAsync(Guid gameId, string userId, Guid? beforeMessageId = default, int take = GameMessageSupport.DefaultPageSize, CancellationToken cancellationToken = default)
