...
{
    public async Task<ResetPasswordOutcome> HandleAsync(string email, string code, string password, string confirmPassword)
    {
        ...
        {
            return new ResetPasswordOutcome(ResetPasswordOutcomeStatus.PasswordMismatch, email, code);
        }
